...
function save(_ref) {
  ...
  const classes = classnames__WEBPACK_IMPORTED_MODULE_3___default()(`text-box-align-${textAlignment}`, {
    'has-shadow': shadow,
    [`shadow-opacity-${shadowOpacity}`]: shadow && shadowOpacity
  });
...
const v1 = {
  ...
  attributes: { ...(0,loadsh__WEBPACK_IMPORTED_MODULE_4__.omit)(_block_json__WEBPACK_IMPORTED_MODULE_5__.attributes, ['textAlignment']),
    alignment: {
      type: 'string',
      default: 'left'
    },
  ...
  migrate: attributes => {
    return { ...(0,loadsh__WEBPACK_IMPORTED_MODULE_4__.omit)(attributes, ['alignment']),
...
const v2 = {
  supports: {
    ...
    attributes: { ...(0,loadsh__WEBPACK_IMPORTED_MODULE_5__.omit)(_block_json__WEBPACK_IMPORTED_MODULE_4__.attributes, ['textAligment']),
      aligment: {
        type: "string",
        default: "left"
      }
  ...
  migrate: attributes => {
    return { ...(0,loadsh__WEBPACK_IMPORTED_MODULE_5__.omit)(attributes, ['alignment']),
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"blocks-course/text-box","version":"0.1.0","title":"Text Box","category":"text","icon":"text-page","description":"A simple text box.","keywords":["text","paragraph","box"],"supports":{"html":false,"color":{"text":true,"background":true,"gradients":true},"spacing":{"padding":true}},"styles":[{"name":"squared","label":"Squared","isDefault":true},{"name":"rounded","label":"Rounded","isDefault":false}],"example":{"attributes":{"text":"This is some text","gradient":"magenta-blue","shadow":true,"color":"white"}},"textdomain":"text-box","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"text":{"type":"string","source":"html","selector":"p"},"textAlignment":{"type":"string","default":"left"},"shadow":{"type":"boolean","default":false},"shadowOpacity":{"type":"number","default":30},"backgroundColor":{"type":"string"},"textColor":{"type":"string"},"gradient":{"type":"string"},"style":{"type":"object","default":{"color":{"background":"#f30","text":"#fff"},"spacing":{"padding":{"top":"15px","right":"15px","bottom":"15px","left":"15px"}}}}}}');
